...
**R1-5. "Abstract: please don't use acronyms (so many) without definition."**

The abstract was rewritten. All acronyms that remain (FSNSI, N, P, PLSR, PLS-SEM) are now defined at first occurrence in the abstract itself. Acronyms used only once were replaced by the full term.

**R1-6. "Lines 54-55: this information is twice (see lines 52-53)."**

The duplicate sentence was removed and the passage was consolidated into a single statement.

**R1-7. "Lines 72-99: these soil processes are well known, please summarize."**

The two original paragraphs describing basic SOM dynamics and humic fractionation were condensed. The first paragraph now focuses on the conversion-driven reduction of N and P stocks, and the second on the Cerrado-specific context. A caveat paragraph was added to explicitly state that humic fractionation is used as an operational partition rather than a mechanistic assumption of persistence.

**R1-8. "Lines 100-124: too much general information about the sustainability models; the connection with the N and P focus is lacking; 'fuzzy' word use needs explanation."**

The models paragraph was revised to explicitly connect PLS-SEM to N and P stocks (rather than generic "nutrient stocks") and to describe the pathways through which organic and mineral phases control nutrient retention. The fuzzy concept is now explained as a method that employs membership functions to represent continuous soil responses as degrees of belonging to qualitative categories (e.g., low, medium, or high functionality), translating N and P fractions and bulk density into a single aggregated index without imposing rigid categorical thresholds. The Fuzzy Soil Nutritional Sustainability Index (FSNSI) is introduced as the composite indicator resulting from the combination of PLS-SEM and fuzzy inference.

**R1-9. "Lines 125-131: these concepts are well known; the paragraph must be moved before the models mention (line 99)."**

Done. The paragraph on soil physical degradation (bulk density increase, disruption of organomineral complexes, restrictions on gas diffusion and microbial activity) was moved to precede the models section, establishing the physical constraint before introducing the analytical tools that quantify its effect.

**R1-10. "Lines 132-134: this hypothesis is obvious and not necessary."**

The hypothesis was entirely rewritten. The new formulation proposes a specific, testable mechanism: nutrient stabilization is primarily controlled by the balance between humic retention and labile turnover, with bulk density mediating the intensity of biogeochemical fluxes. The predictions (native vegetation maintains stronger humic co-stabilization; managed systems show higher allocation to labile and residual compartments with weaker nutrient coupling) are non-trivial and directly linked to the PLSR and PLS-SEM analyses.

**R1-11. "Lines 135-138: the land use types (native vegetation, silviculture and agriculture) have neither been mentioned nor justified."**

The Introduction now explicitly presents the five evaluated systems: Cerrado sensu stricto (preserved native savanna vegetation, serving as reference), three monoculture forest plantations (*Eucalyptus* sp., *Khaya ivorensis*, and *Tectona grandis*), and conventional agriculture. The text states that these systems span a gradient of post-conversion management intensity characteristic of the region.

**R1-12. "Lines 139-147: this paragraph is confusing, redundant, and not necessary — eliminate."**

The paragraph was eliminated. Its relevant content was either absorbed into more specific paragraphs or removed entirely.
