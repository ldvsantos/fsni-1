...
Ao projetar as frações húmicas e lábeis no espaço latente do PLSR para o nitrogênio total, a organização vetorial explicita quais compartimentos covariam com o estoque total e com que coerência direcional (Figura 4). Em termos de balanço de massa, a partição composicional do nitrogênio total em compartimentos húmicos e lábeis evidencia a predominância de reservatórios de alta inércia temporal. Considerando a soma das frações húmicas obtidas por fracionamento IHSS, ácido fúlvico, ácido húmico e humina, em relação ao total, a contribuição húmica apresentou mediana de 76,0%, com intervalo interquartil de 74,48 a 79,45% e amplitude de 72,09 a 82,85% para o nitrogênio.

Em contrapartida, a soma das frações lábeis, composta por matéria orgânica leve e fração lábil oxidável, permaneceu em patamar substancialmente inferior, com mediana de 12,18%, intervalo interquartil de 11,47 a 12,73% e amplitude de 9,09 a 13,77%, enquanto a fração residual, definida como a parcela do total não recuperada pela soma das frações húmicas e lábeis, apresentou mediana de 11,47% e amplitude de 3,38 a 18,83%. Para o fósforo, o ordenamento entre compartimentos preservou a dominância húmica observada para o nitrogênio, corroborando a co-estratificação dos macronutrientes dentro do arcabouço organomineral, em consonância com o conceito de matéria orgânica associada a minerais, no qual a associação preferencial com silte e argila e a proteção física em microagregados reduzem a acessibilidade microbiana e prolongam a residência dos elementos no sistema [@Lavallee2020].

No biplot do PLSR, a coerência direcional entre o nitrogênio total e as frações húmicas é compatível com a hierarquia quantitativa observada na partição composicional, na qual a maior parte do N está alocada em frações de maior complexidade estrutural (Figura 4). Em termos mecanísticos, essa dominância implica que a retenção de N é governada por incorporação progressiva em redes orgânicas de baixa biodegradabilidade e por interação com superfícies minerais que impõem barreiras físico-químicas ao acesso enzimático, reforçando uma dinâmica de imobilização e reestabilização contínua. Como a humificação opera como mecanismo de transferência de massa entre um compartimento de alta rotatividade e um compartimento de alta persistência, a fração lábil tende a atuar como reservatório de curto prazo e não como determinante do estoque de longo prazo, coerente com sua contribuição percentual reduzida e com sua maior sensibilidade a perturbações e microclima [@Stevenson1994].
...
Em paralelo, a dinâmica do fósforo em Latossolos altamente intemperizados é constrangida por reações de alta afinidade com óxidos de Fe e Al e por processos de adsorção específica via troca de ligantes, que removem rapidamente o fosfato da solução e aumentam a impedância química para sua ciclagem biológica. Nesse cenário, a matéria orgânica não atua apenas como um reservatório de carbono, mas como modulador geoquímico da disponibilidade de P, reduzindo a energia livre efetiva de retenção mineral por competição por sítios reativos e por complexação de metais, além de prover substratos e microambientes que favorecem a incorporação de P em frações organominerais mais persistentes. Essa leitura é compatível com a síntese de @Gerke2022, na qual a dominância de óxidos em solos intemperizados intensifica a sorção de fosfato e desloca a regulação de P para o acoplamento entre fase mineral e matéria orgânica.

Quando essa mesma lógica é aplicada ao fósforo total, a organização vetorial no PLSR evidencia se o estoque permanece acoplado às frações de maior persistência e como as frações lábeis se posicionam em relação ao gradiente de resposta (Figura 5).
...
Quando a comparação é sintetizada em três macro-sistemas, vegetação nativa, plantios florestais e agricultura, observa-se uma ordem funcional que ajuda a reduzir ambiguidade interpretativa. O Cerrado preservado apresentou a maior contribuição húmica, com mediana de 82,0% e fração residual de 4,96%, enquanto a agricultura apresentou a menor contribuição húmica, com mediana de 73,0% e fração residual de 17,15%. Os plantios florestais exibiram condição intermediária, com mediana de 76,0% na contribuição húmica e fração residual de 11,47%, sugerindo que a transição Cerrado para sistemas arbóreos manteve parte substancial da arquitetura de estabilização, porém com redistribuição de massa entre compartimentos, em consonância com mecanismos de proteção organomineral e rotas contrastantes entre matéria orgânica particulada e associada a minerais descritos para sistemas florestais [@Paul2016; @Ferreira2021].
...
Para converter a covariação observada nos biplots do PLSR em uma leitura causal de efeitos diretos e indiretos, a modelagem de equações estruturais explicita a arquitetura hierárquica dos compartimentos funcionais e sua conectividade mecanística (Figura 6). Os altos coeficientes de caminho positivos das frações húmicas para os estoques totais, com β > 1,2, corroboram que a estabilização em frações de maior inércia temporal governa o acúmulo de capital químico em Latossolos tropicais. Em contrapartida, os coeficientes negativos observados para as frações lábeis, com β ≈ -0,3, não representam penalização funcional, mas uma assinatura quantitativa de transferência de massa entre um reservatório de alta rotatividade e um reservatório persistente, compatível com a cinética de humificação e com o caráter transitório do compartimento lábil [@HairJr2021].
...
## 3.5 Integração fuzzy da funcionalidade edáfica e índice fuzzy de sustentabilidade nutricional do solo (FSNSI)
...
Esse desempenho superior do Eucalipto em relação ao Cerrado, no FSNSI, deve ser interpretado como um resultado condicionado ao recorte amostral e ao modo como o índice pondera capital químico (N e P) e restrição física (densidade do solo), e não como uma afirmação geral de superioridade ecológica. Em termos de engenharia de sistema, o padrão é compatível com um regime de entrada de nutrientes e biomassa que eleva o capital químico sem introduzir degradação física concomitante, sobretudo quando não há preparo mecânico recorrente após o estabelecimento do plantio [@Iversen2022]. A fertilização inicial e o rápido acúmulo de biomassa do Eucalipto, combinados com a ausência de perturbação mecânica do solo após o plantio, operam como um pulso de disponibilidade e aporte orgânico que aumenta a eficiência aparente do sistema quando ponderado pela densidade do solo. Evidência análoga foi reportada por @Tang2023, que observou que plantações bem manejadas podem superar linhas de base nativas em funções específicas do solo sob insumos otimizados.

Ao considerar a distribuição do índice ao longo dos usos da terra, o deslocamento das medianas e a dispersão intrauso tornam explícita a heterogeneidade funcional que o agregado fuzzy integra (Figura 9).
...
As fortes correlações positivas, com r > 0,6, entre o FSNSI e as frações lábeis e húmicas validam a coerência interna do índice, pois o escore responde simultaneamente ao capital químico persistente e ao capital de rápida renovação, sob penalização por impedância física via densidade. Essa propriedade de integração reduz a entropia interpretativa típica de leituras univariadas e aproxima a avaliação de fertilidade de uma leitura de funcionalidade, na qual processos de estabilização, ciclagem e restrição física coexistem como componentes acoplados do desempenho do sistema.

Como o diagnóstico deriva de uma campanha amostral pontual, a inferência representa o estado do sistema sob as condições edafoclimáticas do período de coleta, de modo que variações interanuais de precipitação e temperatura podem modular o balanço entre mineralização, estabilização e adsorção, especialmente em ambientes tropicais. A continuidade do monitoramento em campanhas subsequentes é, portanto, necessária para testar a estabilidade temporal das relações estruturais estimadas e para validar a robustez do FSNSI como indicador operacional em cenários de maior variabilidade climática [@Vereecken2018; @Toth2018].
...
O conjunto de dados utilizado nas análises está disponível no repositório do projeto em `artigo_5/fsni/6-ESTATISTICA/dados.csv`.
