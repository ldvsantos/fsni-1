---
title: "Coestabilização de nitrogênio e fósforo nas frações húmicas governa a funcionalidade nutricional do solo sob diferentes usos da terra em Latossolos do Cerrado brasileiro"
...
A conversão de ecossistemas naturais em sistemas agrícolas e silviculturais reconfigura a cinética de estabilização organomineral e, consequentemente, os estoques de nitrogênio e fósforo em Latossolos do Cerrado. Este estudo examina como N e P são conjuntamente estabilizados nas frações húmicas e lábeis sob cinco usos contrastantes da terra, e integra essa evidência em um Índice Fuzzy de Sustentabilidade Nutricional do Solo (FSNSI) utilizado como ferramenta de suporte à decisão que combina capital químico, expresso por estoques de N e P, e restrição física, expressa pela densidade do solo. A partição composicional indicou dominância das frações húmicas em relação ao total, com mediana de contribuição húmica de 76,0% para o N e baixa contribuição das frações lábeis, com mediana de 12,18%, sustentando um regime de retenção controlado por reservatórios recalcitrantes. A vegetação nativa apresentou a maior contribuição húmica, com mediana de 82,0%, e a menor fração residual (4,96%), enquanto a agricultura mostrou contribuição húmica reduzida (mediana de 73,0%) e fração residual aumentada (17,15%), sugerindo maior alocação de massa em compartimentos não recuperados pelas extrações operacionais. Os plantios florestais apresentaram mediana de estoque total de nitrogênio por camada de 1,362, aproximadamente 21,2% superior ao Cerrado nativo, mantendo um regime de estabilização dominado por frações húmicas. O FSNSI discriminou os usos da terra (p < 0,001), com médias ajustadas em ordem decrescente de Eucalipto (6,07), Mogno (4,54), Cerrado (4,42), Agricultura (4,25) e Teca (2,77), indicando que o desempenho funcional é máximo quando há aporte orgânico contínuo sem perturbação mecânica recorrente e mínimo onde a impedância bioquímica restringe a ciclagem de nutrientes. Conclui-se que a coestabilização de N e P em frações húmicas, modulada pela integridade física do solo e por diferenças no aporte subterrâneo de matéria orgânica entre usos da terra documentadas na mesma região do Cerrado, constitui o mecanismo central que sustenta a funcionalidade nutricional em ambientes tropicais altamente intemperizados, e que o FSNSI fornece uma métrica integrada que vincula o manejo de espécies arbóreas e a estrutura física do solo à estabilização de nutrientes, apoiando a avaliação da funcionalidade do solo entre sistemas de uso da terra.

**Palavras-chave:** Acoplamento nitrogênio–fósforo; Efeito de espécies arbóreas; Frações da matéria orgânica do solo; Substâncias húmicas; Aporte subterrâneo de carbono; Latossolo.
...
Uma dimensão ainda pouco explorada diz respeito à origem subterrânea da matéria orgânica que alimenta essas frações estáveis. O carbono e o nitrogênio derivados de raízes contribuem desproporcionalmente para os pools associados a minerais e humificados em relação à serapilheira aérea, porque exsudatos radiculares e a renovação de raízes finas entregam substratos diretamente na rizosfera, onde a proteção organomineral é mais eficiente [@cotrufo2021; @Iversen2022]. Espécies arbóreas diferem acentuadamente em biomassa de raízes finas, distribuição vertical e teor de nutrientes nos tecidos, e esses atributos subterrâneos podem governar quanto N e P são direcionados para compartimentos persistentes em vez de lábeis. Na mesma região do Cerrado de Tocantins, a biomassa radicular e os estoques de elementos sob vários desses usos da terra, incluindo Cerrado nativo, eucalipto e agricultura, foram quantificados de forma independente [@Lima2023], fornecendo evidência local de que os aportes subterrâneos diferem substancialmente entre usos da terra e oferecendo base mecanística para interpretar contrastes de particionamento de frações que de outro modo seriam atribuídos à qualidade não medida dos resíduos.

A intensificação agrícola e o preparo convencional reduzem a matéria orgânica particulada e rompem complexos organominerais, aumentam a densidade do solo e diminuem a porosidade [@Iversen2022]. Esses efeitos físicos restringem a difusão de gases, a infiltração de água e a atividade microbiana, comprometendo a ciclagem de nutrientes e a coestabilização de N e P [@Vereecken2018]. A degradação física, expressa pelo aumento da densidade do solo, limita assim a funcionalidade edáfica e interage com processos biogeoquímicos, afetando a sustentabilidade em múltiplas escalas [@Wagai2020; @Mendes2019].

Apesar desses avanços na compreensão dos processos edáficos, permanece uma lacuna metodológica crítica em relação a indicadores de sustentabilidade que sejam simultaneamente robustos, capazes de lidar com não linearidade e incerteza, e integráveis em arcabouços mais amplos de avaliação de sustentabilidade [@Ros2022]. Indicadores tradicionais de fertilidade ou qualidade do solo são frequentemente reducionistas, unidimensionais ou de difícil interpretação fora do domínio da ciência do solo [@Vereecken2018]. Para informar a avaliação de sustentabilidade do ciclo de vida e decisões de cadeia de suprimentos, é necessário desenvolver métricas que traduzam a complexidade do solo em um índice agregado e escalável [@Toth2018].

Avanços recentes na modelagem permitiram a integração de múltiplos atributos edáficos para investigar essas relações. A modelagem de equações estruturais por mínimos quadrados parciais (PLS-SEM) permite identificar relações causais entre compartimentos do solo, quantificando efeitos diretos e indiretos de variáveis como densidade do solo e frações húmicas nos estoques de N e P, revelando assim as vias pelas quais fases orgânicas e minerais controlam a retenção de nutrientes [@HairJr2021]. Sistemas de inferência fuzzy empregam funções de pertinência para representar respostas edáficas contínuas e não lineares como graus de pertencimento a categorias qualitativas (e.g., funcionalidade baixa, média ou alta), traduzindo múltiplas variáveis de entrada químicas e físicas, incluindo frações de N e P e densidade do solo, em um único índice agregado sem impor limiares categóricos rígidos [@Mamdani1977; @Reis2023]. A combinação de PLS-SEM e inferência fuzzy suporta indicadores compostos como o Índice Fuzzy de Sustentabilidade Nutricional do Solo (FSNSI), que sintetiza a funcionalidade biogeoquímica sob diferentes usos da terra [@Reis2023; @Suganya2024EMA].

Com base nesse contexto, o estudo testa a hipótese de que a estabilização de nutrientes em Latossolos do Cerrado é primariamente controlada pelo balanço entre retenção húmica e renovação lábil, enquanto a densidade do solo media esse balanço modificando a intensidade dos fluxos biogeoquímicos. Sob esse mecanismo, espera-se que a vegetação nativa mantenha maior coestabilização de N e P em frações húmicas, enquanto sistemas manejados apresentem maior alocação para compartimentos lábeis e residuais e acoplamento mais fraco entre os ciclos de nutrientes [@YangPost2011; @Jensen2020; @Macci2016]. Cinco sistemas representativos de uso da terra sobre o mesmo substrato Latossólico no Cerrado brasileiro foram selecionados para testar essa hipótese, abrangendo vegetação nativa de savana preservada (Cerrado sensu stricto, como referência), três plantios florestais monoespecíficos (*Eucalyptus* sp., *Khaya ivorensis* e *Tectona grandis*) e agricultura convencional, que coletivamente abrangem um gradiente de intensidade de manejo pós-conversão característico da região.

Dentro desse arcabouço, o FSNSI emerge como solução relevante [@Ros2022], sintetizando a dinâmica de N e P com métricas de degradação física para simultaneamente diagnosticar a sustentabilidade local e fornecer um indicador quantitativo agregado para a fase de produção dentro de uma perspectiva de pensamento do ciclo de vida [@Sala2019; @Powlson2011]. A funcionalidade do solo quantificada dessa forma torna-se um insumo para avaliação de sustentabilidade do ciclo de vida e suporte à decisão em gestão da terra [@Jha2025EMA], enquanto seu acoplamento a camadas de SIG pode apoiar a priorização espacial de intervenções de manejo e a identificação de hotspots de risco funcional para monitoramento e avaliação ambiental [@Yang2025EMA]. Este estudo objetivou avaliar a dinâmica funcional de N e P nas frações húmicas e lábeis do solo sob esses cinco usos da terra, e propor e validar um arcabouço analítico integrado (PLSR, PLS-SEM e FSNSI) para diagnosticar a sustentabilidade nutricional do solo.
...
| Mogno africano (*K. ivorensis*) | 1,94 ha | 7 anos | Limpeza; aração e gradagem | 1.111 mudas ha⁻¹ (3 × 3 m; desbaste para 6 × 6 m) | NPK 00-10-10 e esterco bovino por cova; reaplicações no 1º ano [@Lucena2024] |
| Teca (*T. grandis*) | 1,12 ha | 10 anos | Limpeza; aração e gradagem | 1.667 mudas ha⁻¹ (3 × 2 m) | Coberturas com NPK 20-05-20 no 1º ano [@Vieira2017] |
...
A base de conhecimento consistiu em dezesseis regras fuzzy no formato SE-ENTÃO, utilizando o operador lógico E (mínimo) para agregar antecedentes. O conjunto de regras codificou a lógica agronômica de que estoques elevados de N e P combinados com baixa densidade do solo geram alta funcionalidade, ao passo que as quatro regras que associaram capital químico favorável a densidade do solo elevada receberam peso maior (1,5 contra 1,0), de modo que a impedância física penalizou o escore mesmo sob suficiência de nutrientes e impediu que camadas compactadas alcançassem a classe Alta apenas por critério químico. O grau de ativação ($\alpha_i$) de cada regra foi calculado conforme a Eq. 2:
...
### 2.5.3 Consistência e robustez do índice

Três verificações independentes sustentaram a validade interna do índice. As correlações de Pearson entre o FSNSI e seus reservatórios constituintes confirmaram que o escore agregado acompanha o capital químico subjacente, os intervalos de confiança por bootstrap propagados pelo GLM (n = 1.000) quantificaram a estabilidade das médias ajustadas entre usos da terra, e a concordância entre o ordenamento fuzzy e os coeficientes estruturais independentes do PLS-SEM forneceu evidência convergente a partir de duas rotas metodologicamente distintas.

## 2.6 Análise de dados

Os dados foram analisados por modelos lineares generalizados multivariados (GLM) com reamostragem bootstrap (n = 1000) para avaliar os efeitos do uso da terra e da profundidade do solo nas frações de N e P, estoques e FSNSI. A abordagem GLM foi adotada em detrimento da ANOVA tradicional devido à não normalidade e heterocedasticidade (Shapiro-Wilk, p < 0,01). A distribuição Gama foi selecionada com base em menores AIC e BIC comparados com distribuições normal e log-normal [@Akaike1974; @McCullaghNelder2019]. A adequação do modelo foi confirmada pela análise residual (Deviance/gl < 1) e ausência de superdispersão [@CameronTrivedi1990]. 

Seguindo recomendações atuais sobre relato de tamanhos de efeito juntamente com níveis de significância, os efeitos do uso da terra sobre o FSNSI foram quantificados como coeficientes exponenciados (Exp(B)) com intervalos de confiança bootstrap de 95%, que expressam a magnitude do efeito na escala original da resposta e são mais informativos para interpretação prática do que testes de significância isolados, pois um teste significativo indica apenas desvio do nulo, enquanto Exp(B) quantifica a média predita sob cada condição de tratamento.
...
As frações húmicas representaram mediana de 76,0% do N total (IIQ: 74,48 a 79,45%; amplitude: 72,09 a 82,85%), indicando dominância de reservatórios de alta inércia em Latossolos do Cerrado. No espaço latente do PLSR (Figura 3), as frações húmicas exibem coerência direcional com o nitrogênio total, sustentando essa hierarquia de balanço de massa. Essa predominância húmica é consistente com valores relatados para Latossolos do Cerrado sob vegetação nativa e convertida, nos quais humina e ácidos húmicos concentram a maior parte do N estabilizado [@Gmach2018; @Ferreira2021], reforçando que a proteção organomineral, e não a renovação lábil, governa o reservatório de N existente nesses solos.
...
Os estoques totais de nitrogênio por camada ordenaram-se de forma decrescente como Teca (mediana EstNT = 1,383), Eucalipto (1,335), Mogno (1,295), Agricultura (1,171) e Cerrado (1,124), correspondendo a incrementos de 23,0%, 18,8%, 15,2% e 4,1% em relação à linha de base nativa. O estoque mais elevado observado na agricultura provavelmente reflete adições sustentadas de N mineral por ciclos de fertilização (Tabela 1), que suplementam o N de origem orgânica e complicam a comparação direta com vegetação nativa não fertilizada. Nenhuma das três espécies de plantio é leguminosa fixadora de nitrogênio, de modo que os ganhos de estoque em sistemas silviculturais não podem ser atribuídos à fixação biológica de N e são mais plausivelmente explicados pelo aporte contínuo de serapilheira, renovação radicular e reduzida perturbação pós-estabelecimento [@SouzaAlmeida2021; @MoraesWS2024]. Acúmulo superficial de N comparável sob plantios arbóreos em relação à savana nativa já foi relatado para sítios brasileiros em substratos intemperizados [@Tang2023], corroborando a plausibilidade da magnitude aqui observada. A dinâmica dos estoques totais de N não deve ser equiparada às tendências da MOS como um todo, pois o acúmulo de N reflete o resultado combinado de incorporação de N orgânico, retenção de N mineral e estabilização fração-específica, processos que podem divergir das trajetórias da MOS orientadas pelo carbono [@Gerke2022]. Esse contraste sugere que os ganhos de estoque dependem primariamente de como cada sistema de manejo modula a qualidade do aporte orgânico, o tempo de residência e a proteção dentro de domínios organominerais, mais do que da magnitude do aporte isoladamente.
...
As espécies arbóreas imprimiram assinaturas distintas na partição de N e P, porque contrastes na química da serapilheira, na renovação de raízes finas e na perturbação pós-estabelecimento se propagam ao peso relativo da estabilização húmica frente à lábil. A análise multigrupo mostrou coeficientes húmicos variando de β = 1,180 (agricultura) a β = 1,372 (teca), indicando que o manejo altera as vias de estabilização (Tabela 2). O Cerrado nativo apresentou coeficientes húmicos elevados (β = 1,286), representando uma linha de base funcional na qual a ciclagem de nutrientes é hermeticamente acoplada e eficiente.
...
O GLM ajustado indicou efeito estatisticamente significativo do uso da terra sobre o FSNSI (p < 0,001) e bom ajuste do modelo (Deviance/gl = 0,082; Pearson/gl = 0,075). As estimativas marginais ajustadas indicaram maior funcionalidade no sistema Eucalipto, cuja média diferiu significativamente do Cerrado nativo (p < 0,05). As médias marginais ajustadas ordenaram-se de forma decrescente como Eucalipto (Exp(B) = 6,07; IC95%: 5,45–6,69), Mogno (Exp(B) = 4,54), Cerrado (Exp(B) = 4,42; IC95%: 3,80–5,04), Agricultura (Exp(B) = 4,25; IC95%: 3,68–4,82) e Teca (Exp(B) = 2,77), sugerindo que a funcionalidade tende a ser máxima sob aportes orgânicos contínuos sem perturbação do solo pós-estabelecimento e mínima onde a impedância bioquímica restringe a ciclagem.

O Eucalipto superou o Cerrado (Exp(B) = 6,07 versus 4,42), mas esse padrão é condicionado à janela amostral e ao modo como o índice pondera capital químico (N e P) e restrição física (densidade do solo). O resultado é consistente com maiores aportes e perturbação limitada pós-estabelecimento [@Iversen2022], e evidências indicam que plantações bem manejadas podem superar linhas de base nativas para funções específicas do solo sob aportes otimizados [@Tang2023]. Contudo, os intervalos de confiança de Mogno (3,98–5,10), Cerrado (3,80–5,04) e Agricultura (3,68–4,82) sobrepõem-se substancialmente, indicando que esses três sistemas são estatisticamente indistinguíveis em FSNSI no tamanho amostral atual. Apenas Eucalipto e Teca ocupam faixas não sobrepostas, sustentando separação inequívoca exclusivamente nos extremos do gradiente de funcionalidade. Essa sobreposição de intervalos reforça que o ranking deve ser interpretado como tendência e não como hierarquia categórica, e que inferências de manejo derivadas de posições intermediárias requerem replicação adicional ou indicadores complementares para alcançar poder confirmatório.
...
Essa representação conjunta permite comparação direta de estados funcionais entre sistemas de manejo mantendo sensibilidade ao balanço entre estabilização e renovação, propriedade destacada como essencial para índices de qualidade do solo destinados a discriminar trajetórias de uso da terra [@Andrews2002; @MukherjeeLal2014]. Em termos práticos, o modelo identifica se estoques mais elevados estão associados à coestabilização efetiva em compartimentos húmicos ou ao acúmulo transitório sob restrição estrutural, o que é essencial para distinguir regimes nutricionais resilientes de vulneráveis. Ao combinar evidência estrutural baseada em PLS com agregação fuzzy, o FSNSI estende, portanto, comparações descritivas para uma métrica decisória operacional para monitoramento, priorização e direcionamento de manejo, consistente com a demanda por índices abrangentes e quantitativos que superem indicadores isolados em direção à avaliação integrada da saúde do solo [@Rinot2019].
...
O presente estudo focou na dinâmica de nitrogênio e fósforo em frações húmicas e lábeis; os estoques de carbono orgânico do solo (COS) não foram determinados. Como a MOS é a matriz primária da qual as substâncias húmicas derivam, estudos futuros devem integrar medições de COS para avaliar a estequiometria carbono-nutriente e fornecer um panorama mais completo da estabilização organomineral sob diferentes usos da terra. Apesar dessa limitação, a abordagem de fracionamento de N e P, combinada com modelagem estrutural (PLSR e PLS-SEM) e integração fuzzy, captura os mecanismos dominantes de retenção de nutrientes e gera um indicador operacional de sustentabilidade consistente com evidências independentes de Latossolos tropicais [@Gerke2022; @Lavallee2020].
...
Avaliações anteriores focadas em nitrogênio em contextos comparáveis do Cerrado examinaram, em geral, um único nutriente ou perfis mais rasos. O presente estudo avança essa base de evidências ao resolver conjuntamente N e P nas frações húmicas e lábeis até 1 m de profundidade em oito intervalos sobre um substrato Latossólico uniforme, o que isola o mecanismo de coestabilização em vez do comportamento de cada nutriente isoladamente. O acoplamento dessa evidência em nível de frações com medições independentes de estoques radiculares da mesma região do Cerrado [@Lima2023], que documentam aportes subterrâneos contrastantes entre usos da terra, restringe ainda mais a inferência e reduz a dependência de propriedades de resíduo que não foram medidas diretamente na campanha de solo.

# 4. Conclusão

Os resultados sugerem que a funcionalidade nutricional do solo em Latossolos do Cerrado é primariamente regulada por mecanismos de retenção húmica, com a densidade do solo atuando como restrição mediadora dos fluxos biogeoquímicos. O acoplamento entre N e P dentro dessas frações húmicas, mais do que o comportamento de cada nutriente isoladamente, emergiu como o controle central da funcionalidade nutricional, e o contraste entre usos da terra mostrou-se consistente com diferenças no aporte subterrâneo de matéria orgânica documentadas na mesma região do Cerrado. O Índice Fuzzy de Sustentabilidade Nutricional do Solo (FSNSI) proposto diferenciou os sistemas de uso da terra, fornecendo um indicador operacional que integra capital químico e restrição física em uma única métrica de funcionalidade do solo. O FSNSI pode apoiar a priorização de manejo ao identificar sistemas com funcionalidade comprometida, como a agricultura convencional, ao passo que evidencia alternativas silviculturais que preservam parte da arquitetura de estabilização. A capacidade do FSNSI de sintetizar relações biogeoquímicas em uma métrica interpretável pode contribuir para a avaliação da funcionalidade do solo em ambientes tropicais, e seu acoplamento a camadas de dados espaciais pode apoiar a priorização e o monitoramento de rotina em programas de gestão da terra.
...
RNdAF: Renisson Neponuceno de Araújo Filho; LDVS: Luiz Diego Vidal Santos; EGdS: Emersson Guedes da Silva; OdCL: Olavo da Costa Leite; LMP: Ludmilla Morais Pereira; MBSdS: Mateus Barbosa Santos da Silva; JMdS: Jémison Mattos dos Santos. Conceptualização: RNdAF, LDVS, EGdS. Metodologia: RNdAF, LDVS, EGdS. Análise formal: LDVS, JMdS, EGdS. Investigação: RNdAF, OdCL, LMP. Curadoria de dados: LDVS, MBSdS, JMdS. Visualização: LDVS, MBSdS. Redação – rascunho original: LDVS. Redação – revisão e edição: RNdAF, LDVS, EGdS, OdCL, LMP, MBSdS, JMdS. Supervisão: RNdAF, EGdS. Administração do projeto: RNdAF. Aquisição de financiamento: Nenhuma. Todos os autores leram e aprovaram o manuscrito final.
