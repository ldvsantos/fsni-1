...
Este estudo confirma que a funcionalidade nutricional do solo em Latossolos do Cerrado é primariamente regulada por mecanismos de retenção húmica, com a densidade do solo atuando como restrição-chave modulando os fluxos biogeoquímicos. O Índice Fuzzy de Sustentabilidade Nutricional do Solo (FSNSI) proposto discriminou com sucesso os sistemas de uso da terra, fornecendo um indicador operacional que integra capital químico e restrição física em uma única métrica para monitoramento e avaliação ambiental. O FSNSI viabiliza a priorização de manejo ao identificar sistemas com funcionalidade comprometida, como a agricultura convencional, e aqueles com maior desempenho funcional, como plantações florestais que mantêm aporte contínuo de serapilheira sem perturbação do solo pós-estabelecimento. Contudo, a sobreposição dos intervalos de confiança entre os sistemas de posição intermediária (Mogno, Cerrado e Agricultura) indica que a separação categórica na faixa intermediária requer replicação adicional ou indicadores complementares, incluindo a dinâmica do carbono orgânico do solo.

Do ponto de vista prático, os resultados sustentam as seguintes recomendações de manejo para Latossolos do Cerrado: (i) sistemas silviculturais com cobertura permanente de dossel (e.g., Eucalipto, *Khaya ivorensis*) devem ser priorizados em terras degradadas por preservarem as vias de estabilização húmica e manterem baixa densidade do solo; (ii) a agricultura convencional deve incorporar práticas conservacionistas como plantio direto, plantas de cobertura e adubação orgânica para mitigar a redução observada na eficiência húmica e o aumento das frações residuais; (iii) plantações de Teca requerem estratégias de manejo da serapilheira (e.g., cobertura morta, consórcio com espécies de decomposição rápida) para superar a impedância bioquímica causada pela serapilheira recalcitrante e compactação do solo; e (iv) o FSNSI, combinado com camadas de monitoramento espacial, pode servir como ferramenta rotineira de triagem para agências ambientais identificarem hotspots de risco funcional e priorizarem áreas de intervenção em programas de gestão territorial.
